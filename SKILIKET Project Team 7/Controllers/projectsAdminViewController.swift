//
//  projectsAdminViewController.swift
...
class projectsAdminViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "showYourProjectsAdminDetail" {
            if let nextView = segue.destination as? yourProjectsAdminViewController,
